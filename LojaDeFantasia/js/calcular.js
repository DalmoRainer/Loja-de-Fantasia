...
function calcularProduto() {
    var u = document.getElementById("arlequina").value;
    var v = document.getElementById("enfermeira").value;
    var w = document.getElementById("zumbi").value;
    var x = document.getElementById("bruxa").value;
    var y = document.getElementById("vampiro").value;
    var z = document.getElementById("vermelho").value;
